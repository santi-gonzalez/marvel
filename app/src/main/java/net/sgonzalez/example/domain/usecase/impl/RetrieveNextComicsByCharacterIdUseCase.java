...
public class RetrieveNextComicsByCharacterIdUseCase
extends AbsUseCase<Long, PageResult<List<ComicModel>>> {
  private final ComicRepository comicRepository;
  private final ComicMapper comicMapper;

  @Inject
  public RetrieveNextComicsByCharacterIdUseCase(MainThreadExecutor mainThreadExecutor,
