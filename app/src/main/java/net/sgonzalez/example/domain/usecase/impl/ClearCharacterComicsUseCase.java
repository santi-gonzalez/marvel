...
public class ClearCharacterComicsUseCase extends AbsUseCase<Long, Void> {
  private final ComicRepository comicRepository;

  @Inject
  public ClearCharacterComicsUseCase(MainThreadExecutor mainThreadExecutor, NewThreadExecutor newThreadExecutor,
