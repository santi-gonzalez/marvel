...
public class LocalOperation<Params, Result> implements Operation {
  ...
  public LocalOperation(@Nullable Params params, @NonNull RetrieveCallbacks<Result> callbacks,
  ...
  public static abstract class OperationCallbacks<Params, Result> implements Operation.OperationCallbacks<Params, Result> {
    @Override
    public void retrieveFromCloud(@Nullable Params params, @NonNull RetrieveCallbacks<Result> callbacks) {
    }
